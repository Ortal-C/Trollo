...
<template>
  <section class="card-preview-container" v-if="card">
    <section
      ...
      @click="cardDetails"
    >
      <button class="edit-card" @click.stop="openEditCard"><i class="el-icon-edit"></i></button>
      <div
        class="card-cover"
      ...
      <div class="card-content">
        ...
        <div class="card-icons" v-if="card.style.size !== 'full'">
          <div class="card-info">
            <span v-if="card.description" v-html="desc">{{ desc }}</span>
             <span v-if="card.comments.length"><i class="el-icon-chat-dot-square"></i></span>
            <span v-if="card.dueDate" title="This card is due later"><i class="el-icon-time"></i>
