	...
	<div class="group-preview">
		<div class="group-header">
			...
			<div v-if="isOpen" class="dynamic-popover">
				...
				<svg class="close-popover" @click="toggleMenu" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 172 172" style="fill: #000000">
...
export default {
	...
	methods: {
		...
		saveCard({groupId, card}) {
			console.log('GROUP PREVIEW',groupId, card);
