<template>
<svg :stroke="color || 'white'" :fill="color || 'white'" stroke-width="0" viewBox="0 0 24 24" :height="size || '16px'" :width="size || '16px'" xmlns="http://www.w3.org/2000/svg" >
    <path fill="none" stroke="black" stroke-linecap="round" stroke-width="2"
