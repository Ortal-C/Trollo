<template>
    <svg :width="size || '20px'" :height="size || '20px'" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="fill: white;">
        <path fill-rule="evenodd" clip-rule="evenodd" :fill="color || 'white'"
